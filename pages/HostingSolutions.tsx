    ...
    <div className="bg-white dark:bg-[#0d1117] text-gray-900 dark:text-white min-h-screen font-sans transition-colors duration-300">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center pt-24 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-200 dark:border-blue-500/30 bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold uppercase tracking-widest mb-8 shadow-sm dark:shadow-glow-blue animate-fade-in-up">
            <span className="w-2 h-2 rounded-full bg-blue-600 dark:bg-blue-400 animate-pulse"></span>
            Next-Gen Infrastructure
          </div>
          <h1 className="text-5xl md:text-8xl font-bold tracking-tight mb-8 text-gray-900 dark:text-white drop-shadow-sm dark:drop-shadow-2xl animate-fade-in-up">
            {t.hostingHeroTitle}
          </h1>
      ...
      <section className="py-24 px-4 bg-gray-50 dark:bg-[#161b22] border-y border-gray-200 dark:border-gray-800">
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-10 bg-white dark:bg-[#0d1117] rounded-3xl shadow-lg border border-gray-100 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 transition-colors animate-fade-in-up">
      ...
      <section id="pricing" className="py-32 px-4 bg-white dark:bg-[#0d1117]">
         <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
               {plans.map((plan, i) => (
                  <div key={i} className={`relative bg-gray-50 dark:bg-[#161b22] border rounded-3xl p-10 flex flex-col hover:-translate-y-2 transition-transform duration-300 shadow-xl ${plan.highlight ? 'border-blue-500 ring-4 ring-blue-500/10 scale-105 z-10 py-14' : 'border-gray-200 dark:border-gray-800'}`}>
                     {plan.highlight && (
      ...
      <section id="order-form" className="py-32 px-4 max-w-3xl mx-auto border-t border-gray-200 dark:border-gray-800">
         {submitted ? (
            <div className="bg-white dark:bg-[#161b22] border border-green-500/50 rounded-3xl p-12 text-center animate-fade-in-up shadow-2xl">
               ...
               <button onClick={() => setSubmitted(false)} className="text-blue-600 dark:text-blue-400 font-bold hover:underline">{t.submitAnother}</button>
            </div>
         ) : (
